...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-m3qnf*^r5-$-++wc88+(u)h5e*w#wqy-jn^vdw7v##l-ba=s--')
...
ROOT_URLCONF = 'eventhub_config.urls'
...
WSGI_APPLICATION = 'eventhub_config.wsgi.application'
